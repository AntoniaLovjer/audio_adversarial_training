...
class BaseTrainer():
    ...
    def fit_model_new(self, optimizer, n_epochs, LOGFILE_PATH, model_filename, attack, epsilon, alpha, num_iter):
        """ Fit the model for n epochs. Input params:
        
            optimizer: optimizer for the training procedure. 
            n_epochs: number of epochs for training
            LOGFILE_PATH: path for the log file
            model_filename: name of the model which will be saved in the 'saved' folder
            attack: fgsm or pgd_linf
            epsilon: parameter for fgsm and pgd_linf
            alpha: parameter for pgd_linf
            num_iter: iterations for pgd adversarial training   
        """
        self.model.train()
